...
*   **Innate Immunity (இயல்பான நோய் எதிர்ப்பு சக்தி):** Non-specific, present from birth. (பிறப்பிலேயே இருக்கும் பாதுகாப்புப் படை)
    ...
    *   **Cellular Barriers (செல் தடைகள்):** Phagocytes (e.g., neutrophils, macrophages). (பேகோசைட்டுகள்)
    *   **Cytokine Barriers (சைட்டோகைன் தடைகள்):** Interferons. (வைரஸ் பாதித்த செல்கள் வெளியிடும் தடுப்புப் புரதங்கள்)
*   **Acquired Immunity (பெறப்பட்ட நோய் எதிர்ப்பு சக்தி):** Pathogen-specific, develops after exposure. (நோய் வந்த பிறகு அல்லது தடுப்பூசி மூலம் பெறும் பாதுகாப்பு)
    *   **Primary response (முதன்மை எதிர்வினை):** First encounter, slow, low intensity.
...
*   **Hallucinogens (கற்பனை ஊக்கிகள்):** e.g., LSD, Datura, Atropa belladonna.
...
*   **Chemicals, Enzymes, Bioactive Molecules (வேதிப்பொருட்கள், என்சைம்கள், உயிர் செயல் மூலக்கூறுகள்):**
    *   **Acids (அமிலங்கள்):** Citric acid (*Aspergillus niger*), Acetic acid (*Acetobacter aceti*), Butyric acid (*Clostridium butylicum*).
...
**Example 5: Immunity (நோய் எதிர்ப்பு சக்தி)**
A child receives a vaccine against polio. Which type of immunity develops, and how does it protect the child?
**Solution (தீர்வு):**
The child develops **active immunity**. Vaccination introduces inactivated or weakened polio virus (or its components/antigens) into the body. The child's immune system recognizes these as foreign and produces its own antibodies and memory cells against the polio virus. If the child is exposed to the actual polio virus later, the memory cells will mount a rapid and strong secondary immune response, preventing the disease. (தடுப்பூசி மூலம் உடல் தானாகவே நோய் எதிர்ப்பு சக்தியை உருவாக்குகிறது (active immunity), இதனால் எதிர்காலத்தில் நோய் தாக்காமல் பாதுகாக்கப்படும்.)

**Example 6: Plant Breeding (தாவரப் பெருக்கம்)**
A farmer wants to develop a new variety of wheat that is resistant to rust disease and has a high yield. Outline the basic steps involved in a conventional plant breeding program for this goal.
**Solution (தீர்வு):**
1.  **Collection of variability (மாறுபட்ட வகைகளை சேகரித்தல்):** Gather diverse strains of wheat, including those with rust resistance and those with high yield.
2.  **Evaluation and selection of parents (பெற்றோரை மதிப்பிடுதல் மற்றும் தேர்வு செய்தல்):** Identify plants with desired traits (rust resistance and high yield) for crossing.
3.  **Cross-hybridization among the selected parents (தேர்ந்தெடுக்கப்பட்ட பெற்றோரிடையே கலப்பினமாக்கம்):** Artificially cross the selected parent plants to combine their desirable traits.
4.  **Selection and testing of superior recombinants (சிறந்த மறுஇணைவுகளைத் தேர்ந்தெடுத்தல் மற்றும் சோதித்தல்):** Screen the progeny (offspring) for plants that exhibit both rust resistance and high yield.
5.  **Testing, release and commercialization of new cultivars (புதிய சாகுபடி வகைகளை சோதித்தல், வெளியிடுதல் மற்றும் வணிகமயமாக்குதல்):** Test the selected superior lines in various field conditions for several generations and, if stable and superior, release them as new varieties.
(புதிய கோதுமை வகையை உருவாக்க, மாறுபட்ட வகைகளை சேகரித்து, விரும்பிய பண்புகளுக்காக பெற்றோரையும் தேர்வு செய்து, கலப்பினமாக்கி, சிறந்த கலப்பினங்களை சோதித்து வெளியிடுதல்.)

**Example 7: Microbes in Industry (தொழில்துறையில் நுண்ணுயிரிகள்)**
Name a microbe used for producing citric acid and one for producing an immunosuppressive agent.
**Solution (தீர்வு):**
...
1.  Which of the following is an example of a non-infectious disease?
    ...
    C) Cancer
    D) Pneumonia
    **Solution:** C) Cancer (புற்றுநோய்)

2.  The causative agent of typhoid fever is:
    A) *Plasmodium vivax*
    B) *Salmonella typhi*
    C) *Entamoeba histolytica*
    D) Rhinovirus
    **Solution:** B) *Salmonella typhi* (டைபாய்டு காய்ச்சலை ஏற்படுத்தும் நுண்ணுயிர்)

3.  Which cells are primarily targeted by the HIV virus?
    A) B-lymphocytes
    B) Helper T-lymphocytes
    C) Neutrophils
    D) Macrophages
    **Solution:** B) Helper T-lymphocytes (HIV வைரஸால் பாதிக்கப்படும் செல்கள்)

4.  The Y-shaped structure in the immune system is characteristic of:
    A) T-lymphocytes
    B) Antibodies
    C) Macrophages
    D) Interferons
    **Solution:** B) Antibodies (நோய் எதிர்ப்பு சக்தியில் Y-வடிவ அமைப்பு)

5.  Colostrum, the yellowish fluid secreted by the mother during the initial days of lactation, provides:
    A) Active immunity
    B) Passive immunity
    C) Autoimmunity
    D) Cell-mediated immunity
    **Solution:** B) Passive immunity (தாயின் சீம்பால் வழங்கும் நோய் எதிர்ப்பு சக்தி)

6.  Which of the following is a symptom of Filariasis?
    A) Sustained high fever
    B) Elephantiasis
    C) Abdominal pain with blood in stools
    D) Dry, scaly lesions
    **Solution:** B) Elephantiasis (ஃபைலேரியாசிஸ் நோயின் ஒரு அறிகுறி)

7.  The drug 'heroin' is obtained from the plant:
    A) *Cannabis sativa*
    B) *Erythroxylum coca*
    C) *Papaver somniferum*
    D) *Atropa belladonna*
    **Solution:** C) *Papaver somniferum* (ஹெராயின் பெறப்படும் தாவரம்)

8.  The term "metastasis" in the context of cancer refers to:
    A) Programmed cell death
    B) Uncontrolled cell growth
    C) Spread of cancerous cells to distant sites
    D) Differentiation of cells
    **Solution:** C) Spread of cancerous cells to distant sites (புற்றுநோய் செல்கள் பரவுதல்)

9.  Which of the following is a part of innate immunity?
    A) Antibodies
    B) Memory cells
    C) Skin
    D) T-lymphocytes
    **Solution:** C) Skin (இயல்பான நோய் எதிர்ப்பு சக்தியின் ஒரு பகுதி)

10. The biological process of making curd from milk is primarily carried out by:
    A) Yeast
    B) *Acetobacter aceti*
    C) *Lactobacillus*
    D) *Penicillium notatum*
    **Solution:** C) *Lactobacillus* (பால் தயிராக மாறும் செயல்பாடு)

11. *Saccharomyces cerevisiae* is commonly known as:
    A) Mold
    B) Bakers' yeast
    C) Penicillin fungus
    D) Brewer's mold
    **Solution:** B) Bakers' yeast (ரொட்டி ஈஸ்ட்)
...
12. The first antibiotic discovered was:
    ...
    C) Penicillin
    D) Erythromycin
    **Solution:** C) Penicillin (கண்டுபிடிக்கப்பட்ட முதல் நுண்ணுயிர் கொல்லி)

13. Which microbe is used for the production of Cyclosporin A, an immunosuppressive agent?
    A) *Monascus purpureus*
    B) *Trichoderma polysporum*
    C) *Aspergillus niger*
    D) *Clostridium butylicum*
    **Solution:** B) *Trichoderma polysporum* (சைக்கிளோஸ்போரின் A உற்பத்தி செய்யும் நுண்ணுயிர்)

14. What does BOD stand for in sewage treatment?
    A) Bacterial Oxygen Deficiency
    B) Biological Oxygen Demand
    C) Biochemical Oxygen Demand
    D) Biotic Organic Decomposition
    **Solution:** C) Biochemical Oxygen Demand (கழிவுநீர் சுத்திகரிப்பில் BOD என்பதன் பொருள்)

15. Methane-producing bacteria are collectively called:
    A) Denitrifiers
    B) Nitrifiers
    C) Methanogens
    D) Chemoautotrophs
    **Solution:** C) Methanogens (மீத்தேன் உற்பத்தி செய்யும் பாக்டீரியா)

16. Which of the following is a biofertilizer that forms mycorrhizal association with plants?
    A) *Rhizobium*
    B) *Azotobacter*
    C) *Glomus*
    D) *Anabaena*
    **Solution:** C) *Glomus* (மைக்கோரைசல் இணைப்பை உருவாக்கும் உயிரி உரம்)

17. Ladybird beetles are used as biocontrol agents to control:
    A) Aphids
    B) Mosquitoes
    C) Caterpillars
    D) Fungal pathogens
    **Solution:** A) Aphids (ஏஃபிட்களை கட்டுப்படுத்தும் லேடிபேர்ட் வண்டுகள்)

18. Biofortification refers to:
    A) Enhancing soil fertility with biological agents.
    B) Breeding crops with higher levels of vitamins and minerals.
    C) Using biological weapons in warfare.
    D) Fortifying food with artificial nutrients.
    **Solution:** B) Breeding crops with higher levels of vitamins and minerals. (உயர்ந்த ஊட்டச்சத்து கொண்ட பயிர்களை உருவாக்குதல்)

19. Micropropagation is a technique used in:
    A) Animal breeding
    B) Plant breeding
    C) Fisheries
    D) Sericulture
...
20. Which of the following is a common symptom of Amoebiasis?
    ...
    C) Abdominal pain and cramps with blood in stools
    D) Dry cough and headache
    **Solution:** C) Abdominal pain and cramps with blood in stools (அமீபியாசிஸ் நோயின் பொதுவான அறிகுறி)

21. Tobacco smoke contains an alkaloid that stimulates the adrenal gland to release adrenaline and nor-adrenaline. This alkaloid is:
    A) Cocaine
    B) Morphine
    C) Nicotine
    D) Caffeine
    **Solution:** C) Nicotine (புகையிலையில் உள்ள காரப்பொருள்)

22. The primary source of single cell protein (SCP) mentioned is:
    A) Wheat
    B) *Spirulina*
    C) Cow's milk
    D) Fish
    **Solution:** B) *Spirulina* (ஒற்றை செல் புரதத்தின் முதன்மை ஆதாரம்)

23. Which of the following is NOT a step in a plant breeding program?
    A) Collection of variability
    B) Cross-hybridization
    C) Tissue culture of somatic cells to produce clones
    D) Selection and testing of superior recombinants
    **Solution:** C) Tissue culture of somatic cells to produce clones (தாவரப் பெருக்க திட்டத்தின் ஒரு பகுதி அல்ல)

24. Statins, used as blood cholesterol-lowering agents, are produced by:
    A) *Streptococcus*
    B) *Monascus purpureus*
    C) *Aspergillus niger*
    D) *Saccharomyces cerevisiae*
    **Solution:** B) *Monascus purpureus* (ரத்த கொழுப்பைக் குறைக்கும் ஸ்டேட்டின்கள் உற்பத்தி செய்யும் நுண்ணுயிர்)

25. The lymphatic vessels of the lower limbs can be chronically inflamed due to infection by:
...
1.  **Assertion (A):** Active immunity is long-lived.
    **Reason (R):** Active immunity involves the production of memory cells.
    **Solution:** A) (செயல்பாட்டு நோய் எதிர்ப்பு சக்தி நீண்ட காலம் நீடிக்கும், ஏனெனில் அது நினைவக செல்களை உருவாக்குகிறது.)

2.  **Assertion (A):** Patients who have undergone organ transplantation are given immunosuppressive agents.
    **Reason (R):** Immunosuppressive agents prevent the host's immune system from rejecting the transplanted organ.
    **Solution:** A) (உறுப்பு மாற்று அறுவை சிகிச்சை செய்தவர்களுக்கு நோய் எதிர்ப்பு சக்தியைக் குறைக்கும் மருந்துகள் வழங்கப்படுகின்றன, ஏனெனில் அவை உடல் உறுப்பை நிராகரிப்பதைத் தடுக்கின்றன.)

3.  **Assertion (A):** Interferons are effective in protecting against viral infections.
    **Reason (R):** Interferons are released by virus-infected cells and protect non-infected cells from further viral infection.
    **Solution:** A) (இன்டர்ஃபெரான்கள் வைரஸ் தொற்றுகளிலிருந்து பாதுகாக்கின்றன, ஏனெனில் அவை வைரஸ் தாக்கிய செல்களால் வெளியிடப்பட்டு மற்ற செல்களைப் பாதுகாக்கின்றன.)

4.  **Assertion (A):** Plasmodium requires two hosts to complete its life cycle.
    **Reason (R):** The sexual stages of Plasmodium occur in the human host, while asexual stages occur in the mosquito.
    **Solution:** C) (பிளாஸ்மோடியத்திற்கு இரண்டு ஹோஸ்ட்கள் தேவை, ஆனால் காரணம் தவறானது. பாலியல் நிலைகள் கொசுவிலும், பாலிலா நிலைகள் மனிதனிலும் நிகழும்.)
...
6.  **Assertion (A):** *Bacillus thuringiensis* is used as a biological control agent.
    ...
    **Solution:** A) (*Bacillus thuringiensis* ஒரு உயிரி கட்டுப்பாட்டு காரணியாகப் பயன்படுத்தப்படுகிறது, ஏனெனில் இது பூச்சி லார்வாக்களைக் கொல்லும் ஒரு நச்சுத்தன்மையை உருவாக்குகிறது.)

7.  **Assertion (A):** Biogas is also known as Gobar gas.
    **Reason (R):** Biogas is produced from cattle dung (gobar) through anaerobic digestion.
    **Solution:** A) (உயிர் எரிவாயு கோபர் வாயு என்றும் அழைக்கப்படுகிறது, ஏனெனில் இது மாட்டுச் சாணத்திலிருந்து (கோபர்) உற்பத்தி செய்யப்படுகிறது.)

8.  **Assertion (A):** The secondary treatment of sewage is also called biological treatment.
    **Reason (R):** It involves the use of microbes to consume organic matter in the sewage.
    **Solution:** A) (கழிவுநீர் சுத்திகரிப்பின் இரண்டாம் நிலை உயிரியல் சுத்திகரிப்பு என்று அழைக்கப்படுகிறது, ஏனெனில் அது கழிவில் உள்ள கரிமப் பொருட்களை உட்கொள்ள நுண்ணுயிரிகளைப் பயன்படுத்துகிறது.)

9.  **Assertion (A):** *Rhizobium* is a biofertilizer.
    **Reason (R):** It fixes atmospheric nitrogen into usable forms for plants in the root nodules of leguminous plants.
    **Solution:** A) (*ரைசோபியம்* ஒரு உயிரி உரமாகும், ஏனெனில் இது வளிமண்டல நைட்ரஜனை தாவரங்களுக்குப் பயன்படுத்தக்கூடிய வடிவத்தில் சரிசெய்கிறது.)

10. **Assertion (A):** Consumption of alcohol during adolescence can have long-term harmful effects.
    **Reason (R):** Adolescence is a period of rapid physical and psychological development, and alcohol interferes with these processes.
    **Solution:** A) (பருவ வயதில் மது அருந்துவது நீண்டகால தீங்கு விளைவிக்கும், ஏனெனில் இது உடல் மற்றும் உளவியல் வளர்ச்சிக்கு இடையூறாக இருக்கும்.)

11. **Assertion (A):** Biofortification is a method to reduce hidden hunger.
    **Reason (R):** Biofortification increases the nutritional value of crops.
    **Solution:** A) (உயிரியல் மேம்பாடு மறைக்கப்பட்ட பசியைக் குறைக்கும் ஒரு முறையாகும், ஏனெனில் இது பயிர்களின் ஊட்டச்சத்து மதிப்பை அதிகரிக்கிறது.)
...
13. **Assertion (A):** The enzyme 'Streptokinase' is called a 'clot buster'.
    ...
    **Solution:** A) (ஸ்ட்ரெப்டோகைனேஸ் என்சைம் 'clot buster' என்று அழைக்கப்படுகிறது, ஏனெனில் இது மாரடைப்பால் பாதிக்கப்பட்ட நோயாளிகளின் இரத்த நாளங்களில் உள்ள இரத்தக் கட்டிகளை அகற்றப் பயன்படுகிறது.)

14. **Assertion (A):** Secondary immune response is more intense than the primary immune response.
    **Reason (R):** The secondary immune response is mediated by memory cells produced during the primary response.
    **Solution:** A) (இரண்டாம் நிலை நோய் எதிர்ப்பு சக்தி முதன்மை நோய் எதிர்ப்பு சக்தியை விட தீவிரமானது, ஏனெனில் இது முதன்மை எதிர்வினையின் போது உற்பத்தி செய்யப்படும் நினைவக செல்களால் ஏற்படுகிறது.)

15. **Assertion (A):** Cannabis products like marijuana affect the cardiovascular system.
...
2.  **Column I (பட்டி I)**
    ...
    **Column II (பட்டி II)**
    i) Antibodies from mother to fetus
    ii) Vaccination
    iii) Skin barrier
    iv) Memory cells
...
3.  **Column I (பட்டி I)**
    ...
    **Column II (பட்டி II)**
    i) Hallucinogen
    ii) Depressant (Heroin)
    iii) Stimulant (Dopamine interference)
    iv) Affects cardiovascular system (Marijuana)
...
8.  **Column I (பட்டி I)**
    ...
    **Column II (பட்டி II)**
    i) *Saccharum officinarum* x *S. barberi*
    ii) Sonalika
    iii) Jaya
    iv) High lysine and tryptophan
...
13. **Column I (பட்டி I)**
    ...
    **Column II (பட்டி II)**
    i) Methanogens
    ii) Physical removal
    iii) Aerobic microbes
    iv) Masses of bacteria and fungi
...
14. **Column I (பட்டி I)**
    ...
    **Column II (பட்டி II)**
    i) Free-living nitrogen fixer
    ii) Symbiotic nitrogen fixer (legumes)
    iii) Mycorrhiza (phosphorus uptake)
    iv) Nitrogen fixer (paddy fields)

    **Solution:** a-ii, b-i, c-iii, d-iv

15. **Column I (பட்டி I)**
    a) Cancer therapy (Radiotherapy)
    b) Cancer therapy (Chemotherapy)
    c) Cancer therapy (Immunotherapy)
    d) Cancer diagnosis
