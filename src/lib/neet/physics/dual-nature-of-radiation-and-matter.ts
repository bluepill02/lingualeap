    ...
    syllabusMapping: [
         {
            ...
            tnBoardChapter: '12th Std Physics - Vol 2, Chapter 7: Wave Optics (discusses wave nature), Chapter 8 (touches on quantum concepts)',
            ...
            mappingDescription: '12th Std Physics - Vol 2, Chapter 7,8 map to NEET Physics Unit 17'
        }
    ],
    conceptNotes: [],
    workedExamples: [],
