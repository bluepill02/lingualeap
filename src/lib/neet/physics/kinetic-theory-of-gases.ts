...
`,
  ...
  assertionReasons: [
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The reason correctly explains the assertion. The internal energy is the sum of kinetic and potential energies. Since intermolecular PE is zero for an ideal gas, the internal energy is purely the kinetic energy of the molecules, which depends only on temperature."
    },
    {
