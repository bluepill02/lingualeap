...
export const electromagneticWaves: NeetModule = {
  ...
  subject: 'Physics',
  conceptNotes: `
### 1. Electromagnetic Waves (மின்காந்த அலைகள்)
*   **Displacement current (இடப்பெயர்ச்சி மின்னோட்டம்):** The concept introduced by Maxwell. A current that exists when the electric field is changing with time. I_d = ε₀(dΦ_E/dt).
*   **Electromagnetic waves and their characteristics:** Generated by accelerating charges. They are self-sustaining oscillations of electric and magnetic fields.
*   **Transverse nature of electromagnetic waves:** The electric field (E), magnetic field (B), and the direction of propagation are all mutually perpendicular.
*   **Electromagnetic spectrum (மின்காந்த நிறமாலை):** The classification of EM waves according to frequency. Includes radio waves, microwaves, infrared, visible, ultraviolet, X-rays, and gamma rays.
*   **Applications of e.m. waves:** Including their uses in communication, medicine, and industry.
`,
  workedExamples: [
    {
