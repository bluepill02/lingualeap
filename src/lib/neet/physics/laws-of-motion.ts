...
const lawsOfMotionModule: NeetModule = {
  "metadata": {
    ...
    "practice": {
      "mcqs": [
        ...
        },
        {
            ...
            "options": ["Newton's first law", "Newton's second law", "Conservation of linear momentum", "Conservation of energy"],
            "answer": "Conservation of linear momentum",
            "explanation": "It is based on the conservation of linear momentum, which itself is a consequence of Newton's second and third laws. The action (bullet forward) has an equal and opposite reaction (gun backward)."
        },
        {
        ...
        },
        {
            ...
            "answer": "√(rg tanθ)",
            "explanation": "This is the ideal speed for a banked curve where no friction is needed. The horizontal component of the normal force provides the centripetal force. Nsinθ = mv²/r and Ncosθ = mg. Dividing them gives tanθ = v²/rg."
        },
        {
      ...
      "matchTheColumns": [
        ...
        },
        {
            ...
            "column2": ["i) tanθ = v²/rg", "ii) mgsinθ = f_s", "iii) Friction provides centripetal force", "iv) Components of N and f provide F_c"],
        ...
        {
            "column1": ["a) F_net = 0", "b) a = constant", "c) τ_net = 0", "d) Inertial Frame"],
            "column2": ["i) Newton's laws are valid", "ii) Rotational equilibrium", "iii) Translational equilibrium", "iv) Equations of motion are applicable"],
