...
`,
  ...
  assertionReasons: [
    ...
    },
    {
        ...
        answer": "A",
        "explanation": "The reason is correct. The formula for terminal velocity (v_t = [2r²(ρ - σ)g] / 9η) is derived by equating the gravitational force with the buoyant force and the Stokes' viscous drag force. The formula shows v_t ∝ r²."
    },
    {
