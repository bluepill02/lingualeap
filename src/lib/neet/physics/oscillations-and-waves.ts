...
export const oscillationsAndWaves: NeetModule = {
  ...
  subject: 'Physics',
  conceptNotes: `
### 1. Oscillations and Periodic Motion (அலைவுகள் மற்றும் சீரிசை இயக்கம்)
...
*   **Time period (T), frequency (ν), displacement (y) as a function of time.**
*   **Periodic functions:** Functions that repeat their values at regular intervals.
*   **Simple Harmonic Motion (S.H.M.) and its equation; phase:** The fundamental equation is y = A sin(ωt + φ).
*   **Oscillations of a spring - restoring force and force constant:** The restoring force F = -kx.
*   **Energy in S.H.M. - Kinetic and potential energies:** Total energy E = K.E. + P.E. = ½kA² is conserved.
*   **Simple pendulum - derivation of expression for its time period:** T = 2π√(L/g).

### 2. Waves (அலைகள்)
*   **Wave motion:** A disturbance that propagates energy and momentum without the transport of matter.
*   **Longitudinal and transverse waves:** Particles oscillate parallel (longitudinal) or perpendicular (transverse) to the direction of energy transfer.
*   **Speed of travelling wave:** v = νλ.
*   **Displacement relation for a progressive wave:** y(x, t) = A sin(kx - ωt + φ).
*   **Principle of superposition of waves, reflection of waves:** When waves overlap, the resultant displacement is the vector sum. Reflection occurs at a boundary.
*   **Standing waves in strings and organ pipes, fundamental mode and harmonics:** Formed by the interference of two identical waves travelling in opposite directions.
*   **Beats:** The periodic variation in amplitude at a given point due to the superposition of two waves having slightly different frequencies. Beat frequency = |ν₁ - ν₂|.
`,
  workedExamples: [
    {
