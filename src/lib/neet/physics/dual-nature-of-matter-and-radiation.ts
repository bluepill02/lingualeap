...
`,
  ...
  mcqs: [
    ...
    },
    {
        ...
        "explanation": "λ = h/mv. For the same velocity, λ is inversely proportional to mass. The alpha particle has the largest mass among the given options, so it will have the smallest wavelength."
    },
    {
  ...
  matchTheColumns: [
    ...
    {
        "column1": ["a) Red light", "b) Violet light", "c) X-ray", "d) Radio wave"],
