...
const kinematicsModule: NeetModule = {
  ...
  subject: 'Physics',
  conceptNotes: `
### 1. Motion in a Straight Line (நேர்க்கோட்டு இயக்கம்)

*   **Frame of Reference (குறிப்பாயம்):** To describe motion, we need a coordinate system and a clock. This is our frame of reference. The observations about motion can change depending on the frame of reference.
*   **Motion in a Straight Line:** Movement where the object's position changes along a single straight line.
*   **Position, Path Length and Displacement (நிலை, பாதை நீளம் மற்றும் இடப்பெயர்ச்சி):**
    *   **Position-time graph:** A graph that shows an object's position at different times. The slope of this graph gives the velocity.
    *   **Distance (Path Length):** The total length of the path covered. It is a scalar quantity.
    *   **Displacement:** The shortest distance between the initial and final points. It is a vector quantity.
*   **Speed and Velocity (வேகம் மற்றும் திசைவேகம்):**
...
*   **Uniformly Accelerated Motion (சீரான முடுக்கப்பட்ட இயக்கம்):** Motion where the acceleration is constant.
    *   **Velocity-time graph:** A graph showing velocity against time. The slope gives acceleration, and the area under the graph gives displacement.
    *   **Relations for uniformly accelerated motion (Equations of Motion):**
        \\[v = u + at\\]
        \\[s = ut + \\frac{1}{2}at^2\\]
        \\[v^2 = u^2 + 2as\\]

### 2. Motion in a Plane (தளத்தில் இயக்கம்) - Vectors
...
*   **Vector addition and subtraction:** Can be done using the Triangle Law or Parallelogram Law. Subtraction is the addition of a negative vector.
*   **Unit Vector (அலகு வெக்டர்):** A vector with a magnitude of one. It is used to specify a direction. \`Â = A / |A|\`.
*   **Resolution of a vector:** Splitting a vector into its components along the coordinate axes (e.g., A = Aₓî + Aᵧĵ).
*   **Scalar and Vector Products:**
    *   **Scalar (Dot) Product:** **A ⋅ B = ABcosθ**. Results in a scalar.
    *   **Vector (Cross) Product:** **A × B = ABsinθ n̂**. Results in a vector perpendicular to the plane of A and B.
*   **Relative Velocity (சார்பு திசைவேகம்):** The velocity of one object with respect to another. **Vₐₑ = Vₐ - Vₑ**.

### 3. Projectile and Circular Motion (எறியிய மற்றும் வட்ட இயக்கம்)

*   **Projectile Motion (எறியிய இயக்கம்):** Motion of an object thrown into the air, subject only to gravity. The path is a parabola. We analyze the horizontal (constant velocity) and vertical (constant acceleration 'g') motions independently.
*   **Uniform Circular Motion (சீரான வட்ட இயக்கம்):** An object moves in a circle at a constant speed. The velocity vector is always changing direction, so there is an acceleration.
    *   **Centripetal Acceleration (மையநோக்கு முடுக்கம்):** The acceleration directed towards the center of the circle, responsible for changing the direction of the velocity. \\[a_c = \\frac{v^2}{r} = \\omega^2 r\\]
`,
  workedExamples: [
    {
        problem: "A car accelerates from rest to a speed of 20 m/s in 10 s. What is its acceleration? (ஒரு கார் ஓய்வு நிலையிலிருந்து 10 வினாடிகளில் 20 மீ/வி வேகத்தை அடைகிறது. அதன் முடுக்கம் என்ன?)",
        solution: "Using the first equation of motion, `v = u + at`. Given: initial velocity `u = 0`, final velocity `v = 20 m/s`, time `t = 10 s`. Substituting the values: `20 = 0 + a(10)`. Therefore, acceleration `a = 20 / 10 = 2 m/s²`."
    },
    {
        problem: "A stone is dropped from a rising balloon at a height of 76 m. The balloon is ascending with a velocity of 30 m/s. What is the velocity of the stone after 2 seconds? (g=10 m/s²) (ஒரு பலூன் 30 மீ/வி வேகத்தில் மேலே செல்லும்போது, 76 மீ உயரத்திலிருந்து ஒரு கல் கைவிடப்படுகிறது. 2 வினாடிகளுக்குப் பிறகு கல்லின் திசைவேகம் என்ன?)",
        solution: "When dropped, the stone inherits the balloon's upward velocity. So, the initial velocity of the stone, `u = +30 m/s`. The acceleration due to gravity is `a = -g = -10 m/s²`. Time `t = 2 s`. Using `v = u + at`, we get `v = 30 + (-10)(2) = 30 - 20 = 10 m/s`. The positive sign indicates the velocity is still in the upward direction."
    },
    {
        problem: "A projectile is fired at an angle of 45° with the horizontal. Find the ratio of maximum height to horizontal range. (ஒரு எறிபொருள் 45° கோணத்தில் எறியப்படுகிறது. அதன் பெரும உயரம் மற்றும் கிடைத்தள வீச்சு ஆகியவற்றின் விகிதத்தைக் கண்டறியவும்.)",
