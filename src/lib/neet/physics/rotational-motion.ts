...
export const rotationalMotion: NeetModule = {
    ...
    mcqs: [
        ...
        { question: "A flywheel rotating at 300 rpm slows down to a constant rate of 180 rpm in 2 seconds. The angular deceleration is:", options: ["A. π rad/s²", "B. 2π rad/s²", "C. 3π rad/s²", "D. 4π rad/s²"], answer: "B. 2π rad/s²", explanation: "ω_i = 300 rpm = 300 * 2π/60 = 10π rad/s. ω_f = 180 rpm = 180 * 2π/60 = 6π rad/s. α = (ω_f - ω_i)/t = (6π - 10π)/2 = -4π/2 = -2π rad/s². The deceleration is the magnitude, which is 2π rad/s².", neetFrequency: 2 },
