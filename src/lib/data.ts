...
export const flashcards: Flashcard[] = [
  {
    ...
    phonetic: '/nəməˈsteː/',
    audioUrl: '',
    imageUrl: 'https://picsum.photos/seed/hello/400/200',
    stability: 10,
    difficulty: 2,
    interval: 5,
  ...
  },
  {
    ...
    phonetic: '/d̪ʱən.jə.ʋɑːd̪/',
    audioUrl: '',
    imageUrl: 'https://picsum.photos/seed/thank-you/400/200',
    stability: 15,
    difficulty: 1,
    interval: 10,
  ...
  },
  {
    ...
    phonetic: '/bɪl/',
    audioUrl: '',
    imageUrl: 'https://picsum.photos/seed/bill/400/200',
    stability: 20,
    difficulty: 1.5,
    interval: 12,
  ...
  },
  {
    ...
    phonetic: '/hɑ̃ː/',
    audioUrl: '',
    imageUrl: 'https://picsum.photos/seed/yes/400/200',
    stability: 8,
    difficulty: 2.5,
    interval: 4,
...
export const lessons: Lesson[] = [
  {
    ...
    description: 'Learn the essentials for getting your caffeine fix in a Hindi-speaking cafe.',
    category: 'Business Hindi',
    imageUrl: 'https://picsum.photos/seed/coffee-order/600/400',
    flashcardIds: ['fc-1', 'fc-2', 'fc-3', 'fc-4', 'fc-5'],
  },
  {
    id: 'lesson-bh-2',
    title: 'Meeting Colleagues',
    description: 'Master polite introductions and common phrases for the office.',
    category: 'Business Hindi',
    imageUrl: 'https://picsum.photos/seed/colleagues/600/400',
    flashcardIds: [],
  },
  {
    id: 'lesson-bh-3',
    title: 'Scheduling a Meeting',
    description: 'Learn to talk about time, dates, and schedule professional appointments.',
    category: 'Business Hindi',
  ...
  },
  {
    ...
    description: 'Key phrases and vocabulary for giving a professional presentation.',
    category: 'Business Hindi',
