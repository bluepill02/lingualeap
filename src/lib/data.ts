...
export const companionCircles: CompanionCircle[] = [
  ...
  },
  {
    ...
    nameTamil: 'இயற்பியல் அடிப்படைகள்',
    description: 'Master the core concepts of physics with expert guidance and peer support',
    memberCount: 24,
    posts: 18,
    resources: 2,
    type: 'Mentor-led',
  ...
  },
  {
    ...
    nameTamil: 'கரிம வேதியியல் தேர்ச்சி',
    description: 'Peer-driven study group for organic chemistry concepts and reactions',
    memberCount: 18,
    posts: 12,
    resources: 1,
    type: 'Peer Study',
