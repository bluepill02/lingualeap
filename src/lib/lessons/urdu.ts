...
export const urduLessons: MicroLesson[] = [
  { id: 'lesson-urdu-1', title: 'Lesson 1', deckId: 'deck-urdu-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-urdu-2', title: 'Lesson 2', deckId: 'deck-urdu-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-urdu-3', title: 'Lesson 3', deckId: 'deck-urdu-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-urdu-4', title: 'Lesson 4', deckId: 'deck-urdu-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-urdu-5', title: 'Lesson 5', deckId: 'deck-urdu-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-urdu-6', title: 'Lesson 6', deckId: 'deck-urdu-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-urdu-7', title: 'Lesson 7', deckId: 'deck-urdu-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
