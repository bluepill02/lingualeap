...
export const sanskritLessons: MicroLesson[] = [
  { id: 'lesson-sanskrit-1', title: 'Lesson 1', deckId: 'deck-sanskrit-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-sanskrit-2', title: 'Lesson 2', deckId: 'deck-sanskrit-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-sanskrit-3', title: 'Lesson 3', deckId: 'deck-sanskrit-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-sanskrit-4', title: 'Lesson 4', deckId: 'deck-sanskrit-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-sanskrit-5', title: 'Lesson 5', deckId: 'deck-sanskrit-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-sanskrit-6', title: 'Lesson 6', deckId: 'deck-sanskrit-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-sanskrit-7', title: 'Lesson 7', deckId: 'deck-sanskrit-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
