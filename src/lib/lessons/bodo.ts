...
export const bodoLessons: MicroLesson[] = [
  { id: 'lesson-bodo-1', title: 'Lesson 1', deckId: 'deck-bodo-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bodo-2', title: 'Lesson 2', deckId: 'deck-bodo-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bodo-3', title: 'Lesson 3', deckId: 'deck-bodo-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bodo-4', title: 'Lesson 4', deckId: 'deck-bodo-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bodo-5', title: 'Lesson 5', deckId: 'deck-bodo-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bodo-6', title: 'Lesson 6', deckId: 'deck-bodo-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bodo-7', title: 'Lesson 7', deckId: 'deck-bodo-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
