...
export const kashmiriLessons: MicroLesson[] = [
  { id: 'lesson-kashmiri-1', title: 'Lesson 1', deckId: 'deck-kashmiri-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-kashmiri-2', title: 'Lesson 2', deckId: 'deck-kashmiri-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-kashmiri-3', title: 'Lesson 3', deckId: 'deck-kashmiri-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-kashmiri-4', title: 'Lesson 4', deckId: 'deck-kashmiri-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-kashmiri-5', title: 'Lesson 5', deckId: 'deck-kashmiri-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-kashmiri-6', title: 'Lesson 6', deckId: 'deck-kashmiri-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-kashmiri-7', title: 'Lesson 7', deckId: 'deck-kashmiri-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
