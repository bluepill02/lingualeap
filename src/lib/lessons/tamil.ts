...
export const tamilLessons: MicroLesson[] = [
  { id: 'lesson-tamil-1', title: 'Lesson 1', deckId: 'deck-tamil-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-tamil-2', title: 'Lesson 2', deckId: 'deck-tamil-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-tamil-3', title: 'Lesson 3', deckId: 'deck-tamil-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-tamil-4', title: 'Lesson 4', deckId: 'deck-tamil-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-tamil-5', title: 'Lesson 5', deckId: 'deck-tamil-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-tamil-6', title: 'Lesson 6', deckId: 'deck-tamil-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-tamil-7', title: 'Lesson 7', deckId: 'deck-tamil-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
