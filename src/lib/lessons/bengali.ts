...
export const bengaliLessons: MicroLesson[] = [
  { id: 'lesson-bengali-1', title: 'Lesson 1', deckId: 'deck-bengali-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bengali-2', title: 'Lesson 2', deckId: 'deck-bengali-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bengali-3', title: 'Lesson 3', deckId: 'deck-bengali-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bengali-4', title: 'Lesson 4', deckId: 'deck-bengali-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bengali-5', title: 'Lesson 5', deckId: 'deck-bengali-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bengali-6', title: 'Lesson 6', deckId: 'deck-bengali-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-bengali-7', title: 'Lesson 7', deckId: 'deck-bengali-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
