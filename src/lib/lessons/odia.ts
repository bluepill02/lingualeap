...
export const odiaLessons: MicroLesson[] = [
  { id: 'lesson-odia-1', title: 'Lesson 1', deckId: 'deck-odia-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-odia-2', title: 'Lesson 2', deckId: 'deck-odia-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-odia-3', title: 'Lesson 3', deckId: 'deck-odia-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-odia-4', title: 'Lesson 4', deckId: 'deck-odia-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-odia-5', title: 'Lesson 5', deckId: 'deck-odia-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-odia-6', title: 'Lesson 6', deckId: 'deck-odia-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-odia-7', title: 'Lesson 7', deckId: 'deck-odia-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
