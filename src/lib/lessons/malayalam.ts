...
export const malayalamLessons: MicroLesson[] = [
  { id: 'lesson-malayalam-1', title: 'Lesson 1', deckId: 'deck-malayalam-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-malayalam-2', title: 'Lesson 2', deckId: 'deck-malayalam-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-malayalam-3', title: 'Lesson 3', deckId: 'deck-malayalam-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-malayalam-4', title: 'Lesson 4', deckId: 'deck-malayalam-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-malayalam-5', title: 'Lesson 5', deckId: 'deck-malayalam-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-malayalam-6', title: 'Lesson 6', deckId: 'deck-malayalam-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-malayalam-7', title: 'Lesson 7', deckId: 'deck-malayalam-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
