...
export const santaliLessons: MicroLesson[] = [
  ...
  { id: 'lesson-santali-5', title: 'Lesson 5', deckId: 'deck-santali-5', ...{ vocabulary: [{ word: 'ᱱᱚᱣᱟ ᱨᱮᱭᱟᱜ ᱜᱚᱱᱚᱝ ᱛᱤᱱᱟᱹག?', romanization: 'Noa reyag gonong tinag?', definition: 'What is its price?', ipa: '', audioUrl: placeholderAudioDataUri }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
