...
export const gujaratiLessons: MicroLesson[] = [
  { id: 'lesson-gujarati-1', title: 'Lesson 1', deckId: 'deck-gujarati-1', ...{ vocabulary: [{ word: 'નમસ્તે', romanization: 'Namaste', definition: 'Hello/Greetings', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-2', title: 'Lesson 2', deckId: 'deck-gujarati-2', ...{ vocabulary: [{ word: 'પાણી', romanization: 'Pani', definition: 'Water', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-3', title: 'Lesson 3', deckId: 'deck-gujarati-3', ...{ vocabulary: [{ word: 'તમે કેમ છો?', romanization: 'Tame kem chho?', definition: 'How are you?', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-4', title: 'Lesson 4', deckId: 'deck-gujarati-4', ...{ vocabulary: [{ word: 'હું જાઉં છું', romanization: 'Hu jau chhu', definition: 'I go', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-5', title: 'Lesson 5', deckId: 'deck-gujarati-5', ...{ vocabulary: [{ word: 'શું ભાવ છે?', romanization: 'Shu bhav chhe?', definition: 'What is the price?', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-6', title: 'Lesson 6', deckId: 'deck-gujarati-6', ...{ vocabulary: [{ word: 'કારણ કે', romanization: 'Karan ke', definition: 'Because', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-7', title: 'Lesson 7', deckId: 'deck-gujarati-7', ...{ vocabulary: [{ word: 'મારો શોખ', romanization: 'Maro shokh', definition: 'My hobby', ipa: '' }], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
