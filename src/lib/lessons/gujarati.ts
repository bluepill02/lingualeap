...
export const gujaratiLessons: MicroLesson[] = [
  { id: 'lesson-gujarati-1', title: 'Lesson 1', deckId: 'deck-gujarati-1', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-2', title: 'Lesson 2', deckId: 'deck-gujarati-2', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-3', title: 'Lesson 3', deckId: 'deck-gujarati-3', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-4', title: 'Lesson 4', deckId: 'deck-gujarati-4', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-5', title: 'Lesson 5', deckId: 'deck-gujarati-5', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-6', title: 'Lesson 6', deckId: 'deck-gujarati-6', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
  { id: 'lesson-gujarati-7', title: 'Lesson 7', deckId: 'deck-gujarati-7', ...{ vocabulary: [], dialogue: [], culturalTip: '', quizzes: [], followUp: '' } },
];
