...
export default function OdiaPage() {
  const allDecks = allLessonDecks.filter(deck => deck.id.startsWith('deck-odia-'));
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold font-headline">Odia Course</h1>
