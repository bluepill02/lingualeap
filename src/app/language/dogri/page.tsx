...
export default function DogriPage() {
  const allDecks = allLessonDecks.filter(deck => deck.id.startsWith('deck-dogri-'));
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold font-headline">Dogri Course</h1>
