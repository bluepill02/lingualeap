...
import { neetChemistryThermo } from '@/lib/exam-data-neet-thermodynamics';
...
export default function NeetThermodynamicsExamPrepPage() {
    const module = neetChemistryThermo;
