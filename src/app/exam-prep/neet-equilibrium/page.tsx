...
import { neetChemistryEquilibrium } from '@/lib/exam-data-neet-equilibrium';
...
export default function NeetEquilibriumExamPrepPage() {
    const module = neetChemistryEquilibrium;
    ...
    <div className="max-w-4xl mx-auto space-y-8 p-4 md:p-0">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Key Chemistry Terms for NEET</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
